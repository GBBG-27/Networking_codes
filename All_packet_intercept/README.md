...
## UNIX Only
 ...
 to a file.The script was designed to  intercept 
 
 all type of packet.The  packet being transimtted is 
 
 encoded and encrypted so the script decodes it with utf-8,
 
 if the data cannot be decoded,in the file,a question mark is replaced and on the
